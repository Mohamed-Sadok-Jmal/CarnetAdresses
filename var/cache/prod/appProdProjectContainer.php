...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'appartoo_platform.doctrine_listener.application_creation' => 'getAppartooPlatform_DoctrineListener_ApplicationCreationService',
            'appartoo_platform.email.application_mailer' => 'getAppartooPlatform_Email_ApplicationMailerService',
    ...
    /*
     * Gets the 'appartoo_platform.doctrine_listener.application_creation' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Appartoo\PlatformBundle\DoctrineListener\ApplicationCreationListener A Appartoo\PlatformBundle\DoctrineListener\ApplicationCreationListener instance
     */
    protected function getAppartooPlatform_DoctrineListener_ApplicationCreationService()
    {
        return $this->services['appartoo_platform.doctrine_listener.application_creation'] = new \Appartoo\PlatformBundle\DoctrineListener\ApplicationCreationListener($this->get('appartoo_platform.email.application_mailer'));
    }

    /*
     * Gets the 'appartoo_platform.email.application_mailer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Appartoo\PlatformBundle\Email\ApplicationMailer A Appartoo\PlatformBundle\Email\ApplicationMailer instance
     */
    protected function getAppartooPlatform_Email_ApplicationMailerService()
    {
        return $this->services['appartoo_platform.email.application_mailer'] = new \Appartoo\PlatformBundle\Email\ApplicationMailer($this->get('swiftmailer.mailer.default'));
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('HQJq57wkAF', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xnAP1RozEp', 0, '-JSiwpkS15m+JkcI3Ojn3g', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $a->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('EyqZcYIUra', 0, '-JSiwpkS15m+JkcI3Ojn3g', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $a->addEventListener(array(0 => 'postPersist'), $this->get('appartoo_platform.doctrine_listener.application_creation'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'appartoo', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\Appartoo\\PlatformBundle\\Entity'))), 'Appartoo\\PlatformBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('AppartooPlatformBundle' => 'Appartoo\\PlatformBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_dd2b500590d0cce3f02b1cda5b6534cdef6c3211e37a9d3f34e1ee76b9803091');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Appartoo\\PlatformBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Appartoo\\PlatformBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Appartoo\\PlatformBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Appartoo\\PlatformBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('fos_user.util.password_updater'), $this->get('fos_user.util.canonical_fields_updater'), $this->get('doctrine')->getManager(NULL), 'Appartoo\\PlatformBundle\\Entity\\User');
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('webmaster', 'Mohamed Sadok JMAL');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Appartoo\\PlatformBundle/Resources/views'), 'AppartooPlatform');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('6a37f5a0fc269b74465ebfc75d8a7d26072632dc');
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('49LOw7gOZH', 0, '-JSiwpkS15m+JkcI3Ojn3g', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AppartooPlatformBundle' => 'Appartoo\\PlatformBundle\\AppartooPlatformBundle',
            ...
            'secret' => '6a37f5a0fc269b74465ebfc75d8a7d26072632dc',
            'app_webmaster' => 'Mohamed Sadok JMAL',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '6a37f5a0fc269b74465ebfc75d8a7d26072632dc',
            ...
            'validator.mapping.cache.prefix' => 'validator_096d4c2da1d0158ffe1334601ceba456916c83b18db368cff0d846a7da620cad',
            ...
            'fos_user.model.user.class' => 'Appartoo\\PlatformBundle\\Entity\\User',
