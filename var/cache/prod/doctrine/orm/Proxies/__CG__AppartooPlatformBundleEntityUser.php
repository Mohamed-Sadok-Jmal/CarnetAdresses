 ...
 */
class User extends \Appartoo\PlatformBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'contacts', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt'];
        }
     ...
     * {@inheritDoc}
     */
    public function addContact(\Appartoo\PlatformBundle\Entity\Contact $contact)
    {
     ...
     * {@inheritDoc}
     */
    public function removeContact(\Appartoo\PlatformBundle\Entity\Contact $contact)
    {
